...
export const useChainLogoStyles = createStyles((_theme, { empty }) => ({
    root: {
        width: "32px",
        height: "32px",
        position: "relative",
...
export const useMainCardModalBox = createStyles((_theme, { show }) => ({
    root: {
        width: "100%",
        height: "100%",
        position: "absolute",
...
export const useSettingPanelStyles = createStyles((_, { show }) => ({
    root: {
        width: "100%",
        borderRadius: "12px",
        padding: "15px 12px",
...
export const useAddressInputPanelStyle = createStyles((_theme, { show }) => ({
    root: {
        width: `calc(100% - 32px)`,
        borderRadius: "12px",
        padding: "15px 12px",
