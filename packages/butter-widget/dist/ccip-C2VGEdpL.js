import { M as l, N as m, O as y, P as k, Q as O, R as b, T as E, U as L, V as h, W as x } from "./index-jFQGGD_v.js";
class M extends l {
...
async function C(c, { blockNumber: r, blockTag: a, data: o, to: i }) {
  ...
  try {
    ...
    const p = await w({ data: f, sender: t, urls: n }), { data: g } = await b(c, {
      blockNumber: r,
      blockTag: a,
      data: E([
        u,
