...
export const GateWalletName = "Gate";
export class GateWalletAdapter extends BaseMessageSignerWalletAdapter {
    constructor(_config = {}) {
        ...
        Object.defineProperty(this, "_connecting", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_wallet", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "_disconnected", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: () => {
        ...
        Object.defineProperty(this, "_accountChanged", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (newPublicKey) => {
        ...
        if (this._readyState !== WalletReadyState.Unsupported) {
            if (isIosAndRedirectable()) {
                // when in iOS (not webview), set Gate as loadable instead of checking for install
    ...
    async connect() {
        try {
            ...
            if (this.readyState === WalletReadyState.Loadable) {
                // redirect to the Gate /browse universal link
                // this will open the current URL in the Gate in-wallet browser
                const url = encodeURIComponent(window.location.href);
                const ref = encodeURIComponent(window.location.origin);
                window.location.href = `https://Gate.app/ul/browse/${url}?ref=${ref}`;
                return;
            }
            if (this.readyState !== WalletReadyState.Installed)
