...
import { ConnectProvider, OKXConnector, UnisatConnector, BitgetConnector, TokenPocketConnector, BybitConnector } from "@particle-network/btc-connectkit";
...
const BtcProvider = ({ children }) => {
    return (_jsx(ConnectProvider, { options: {
