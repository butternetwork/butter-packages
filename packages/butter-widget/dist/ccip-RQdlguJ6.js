import { a6 as l, a7 as m, a8 as y, a9 as k, aa as b, ab as O, ac as E, ad as L, ae as h, af as x } from "./index-jFQGGD_v.js";
class M extends l {
...
async function C(c, { blockNumber: r, blockTag: a, data: o, to: i }) {
  ...
  try {
    ...
    const p = await w({ data: f, sender: t, urls: n }), { data: g } = await O(c, {
      blockNumber: r,
      blockTag: a,
      data: E([
        u,
