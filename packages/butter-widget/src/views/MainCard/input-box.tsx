...
const InputBox = () => {
  ...
  const handleValueChange = (e: ChangeEvent<HTMLInputElement>) => {
    if (Number(e.target.value) >= 0) dispatch(updateAmount(e.target.value));
  };
  ...
  useSWR(
    [wallet, from, "fetchFromTokenBalance"],
    ([wallet, from]) => {
    ...
    <Box className={classes.root}>
      <Box className={classes.boxRoot}>
        <Box className={classes.addressBar}>
          <Text className={classes.addressLabel} fz={14} fw={700}>
            {t("receive_address")}:
          </Text>
          {!toAddress ? (
            ...
            <Box className={classes.addressText} onClick={handleClickEdit}>
              ...
              >
                {toAddress ? (
                  ...
                  <div style={{ color: "#5C5F65", fontSize: "14px" }}>
                    {" "}
            ...
            <Flex align="center" gap={"xs"} w={"100%"}>
              ...
              >
                ...
                <Flex w={"100%"} align={"center"} justify={"space-between"}>
                  ...
                  <Text fz={12}>
                    {t("balance")}: {from?.chain?.chainId ? balance : 0}
                  </Text>
                </Flex>
              </Flex>
            </Flex>
