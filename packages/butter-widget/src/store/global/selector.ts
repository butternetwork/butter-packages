...
export const selectChainsMap = memoize(
  (state: RootState) => state.global.chainsMap,
);

export const selectMetamaskChains = memoize(
  (state: RootState) => state.global.metamaskChains,
);

export const selectChainById = memoizeWithArgs(
...
export const selectChainLogoById = memoizeWithArgs(
  (state: RootState, chainId: string) => {
    const chainsMap = selectChainsMap(state);
...
export const selectAllChainTokens = memoize(
  (state: RootState) => state.global.tokensForChain,
);
export const selectTokensForNetwork = memoizeWithArgs(
  (state: RootState, network: string) => {
...
export const selectTokenByNetrokAndSymbol = memoizeWithArgs(
  (state: RootState, network: string, symbol: string) => {
...
export const selectShowConfirmCard = memoize(
  (state: RootState) => state.global.showConfirmCard,
);
